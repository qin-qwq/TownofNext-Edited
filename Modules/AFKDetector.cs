...
public static class AFKDetector
{
    ...
    public static void SetupCustomOption()
    {
        ...
        EnableDetector = BooleanOptionItem.Create(90, "EnableAFKDetector", false, TabGroup.SystemSettings, false)
            .SetColor(new Color32(0, 255, 165, 255));

        ConsequenceOption = StringOptionItem.Create(91, "AFKConsequence", [.. Enum.GetNames<Consequence>().Select(x => $"AFKConsequence.{x}")], 0, TabGroup.SystemSettings, false)
            .SetParent(EnableDetector)
            .SetColor(new Color32(0, 255, 165, 255));

        MinPlayersToActivate = IntegerOptionItem.Create(92, "AFKMinPlayersToActivate", new(1, 15, 1), 1, TabGroup.SystemSettings, false)
            .SetParent(EnableDetector)
            .SetColor(new Color32(0, 255, 165, 255));

        ActivateOnStart = BooleanOptionItem.Create(93, "AFKActivateOnStart", false, TabGroup.SystemSettings, false)
            .SetParent(EnableDetector)
            .SetColor(new Color32(0, 255, 165, 255));
    }
