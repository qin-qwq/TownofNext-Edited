...
public abstract class OptionItem
{
    ...
    public CustomGameMode HideOptionInCAR { get; protected set; }
    ...
    public OptionItem(int id, string name, int defaultValue, TabGroup tab, bool isSingleValue, bool vanillaStr)
    {
        ...
        HideOptionInCAR = CustomGameMode.All;
        IsHeader = false;
        IsHidden = false;
        IsText = false;
    ...
    public OptionItem HideInCAR(CustomGameMode value = CustomGameMode.CopsAndRobbers) => Do(i => i.HideOptionInCAR = value);
    ...
    public virtual bool IsHiddenOn(CustomGameMode mode, bool forLobbyView = false, bool checkCollapsedSection = true)
    {
        ...
        return IsHidden || this.Parent?.IsHiddenOn(Options.CurrentGameMode) == true
            ...
            || (HideOptionInCAR != CustomGameMode.All && HideOptionInCAR == mode)
