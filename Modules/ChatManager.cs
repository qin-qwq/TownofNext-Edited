...
namespace TONE.Modules.ChatManager
{
    public class ChatManager
    {
        ...
        public static void SendMessage(PlayerControl player, string message)
        {
            ...
            else if (CheckCommond(ref msg, "shoot|guess|bet|st|gs|bt|猜|赌|賭|sp|jj|tl|trial|审判|判|审|審判|審|compare|cmp|比较|比較|duel|sw|swap|st|换票|换|換票|換|finish|结束|结束会议|結束|結束會議|reveal|展示|rt|rit|ritual|bloodritual|summon|sm|lo|恋人|imp|伪装者|ja|豺狼|ji|狱警|co|巫师|roundup|ru|lassoes|ls|围捕", false)) operate = 2;
