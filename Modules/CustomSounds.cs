...
public static class CustomSoundsManager
{
    ...
    private static readonly string SOUNDS_PATH = OperatingSystem.IsAndroid() ? Path.Combine(Application.persistentDataPath, "TONE-DATA", "resources") : Path.Combine(Environment.CurrentDirectory, "BepInEx", "resources");
