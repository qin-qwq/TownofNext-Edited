...
{
    //private static readonly string BANEDWORDS_FILE_PATH = "./TONE-DATA/BanWords.txt";
    ...
    //                File.WriteAllText(BANEDWORDS_FILE_PATH, GetResourcesTxt($"TONE.Resources.Config.BanWords.{fileName}.txt"));
    //            }
    //        }
    //        catch (Exception ex)
    //        {
