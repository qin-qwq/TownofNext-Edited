    ...
    private void DoQuestion()
    {
        ...
        if (MarkedPlayer != byte.MaxValue)
        {
            ...
            [
                ...
                new SetAnswersQuestion { Stage = 3, Question = "WhoOwns", Answer = "秦始皇", PossibleAnswers = { "Lauryn", "Jackler", "Moe", "Marg", "Sarha", "秦始皇", "Niko", "D1GQ", "KARPED1EM", "Matt" }, QuizmasterQuestionType = QuizmasterQuestionType.WhoOwns },
                ...
                new SetAnswersQuestion { Stage = 5, Question = "TOHEPartners", Answer = "YF", PossibleAnswers = { "Innersloth", "秦始皇", "YF", "一只屑果冻", "slok7565", "鹅探长", "莫名奇妙", "红茶bohea", "甘雨" }, QuizmasterQuestionType = QuizmasterQuestionType.TOHEPartners },
