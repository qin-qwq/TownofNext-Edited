...
internal class Addict : RoleBase
{
    ...
    public override void SetupCustomOption()
    {
        ...
        TimeLimit = FloatOptionItem.Create(Id + 12, "SuicideTimer", new(5f, 180f, 1f), 45f, TabGroup.CrewmateRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Addict])
            .SetValueFormat(OptionFormat.Seconds);
