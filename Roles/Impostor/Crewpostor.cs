...
internal class Crewpostor : RoleBase
{
    ...
    public override bool OnTaskComplete(PlayerControl player, int completedTaskCount, int totalTaskCount)
    {
        ...
        List<PlayerControl> list = Main.EnumerateAlivePlayerControls().Where(x => x.PlayerId != player.PlayerId && !(x.GetCustomRole() is CustomRoles.Mini or CustomRoles.Solsticer)
