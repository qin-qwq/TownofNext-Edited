...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2025.0322.502.000030"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "5.0.2 Beta 3";
    ...
    public static readonly bool canaryRelease = true; // Latest: V5.0.2 Beta 3
