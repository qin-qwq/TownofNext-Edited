...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "1.1.2"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "1.2.0 Beta 2";
    ...
    public static readonly bool canaryRelease = true; // Latest: V1.2.0 Beta 2
