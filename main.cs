...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "2025.0404.510.00020"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "5.1.0 Beta 2";
    ...
    public static readonly bool canaryRelease = true; // Latest: V5.1.0 Beta 2
