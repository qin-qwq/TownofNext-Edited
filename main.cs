...
[BepInPlugin(PluginGuid, "TONE", PluginVersion)]
...
public class Main : BasePlugin
{
    ...
    public static readonly string ForkId = "TONE";
    ...
    public const string PluginVersion = "26.02.23"; // YEAR.MMDD.VERSION.CANARYDEV
    public const string PluginDisplayVersion = "1.8.0 Beta 1";
...
#pragma warning disable IDE1006 // Naming Styles
    ...
    public static bool canaryRelease => RELEASE == Release.BETA; // Latest: V1.8.0 Beta 1
...
#pragma warning restore IDE1006 // Naming Styles
    ...
    public override void Load()
    {
        ...
        Logger = BepInEx.Logging.Logger.CreateLogSource("TONE");
