...
// Credit: https://github.com/Gurge44/EndlessHostRoles/blob/main/Patches/LobbyViewSettingsPanePatch.cs
...
public static class LobbyViewSettingsPanePatch
{
    ...
    private static bool OnlyEnabledRoles = false;
    ...
    public static void Awake_Postfix(LobbyViewSettingsPane __instance)
    {
        ...
        IEnumerator CoAwakeViwer()
        {
            ...
            viewSettingsInfoPanel.checkMark.sprite = Utils.LoadSprite("TONE.Resources.Images.Checkmark.png", 100f);
            ...
            viewSettingsInfoPanel.checkMark.color = new Color32(255, 129, 166, 255);

            viewSettingsInfoPanel.checkMarkOff.sprite = Utils.LoadSprite("TONE.Resources.Images.CheckMarkOff.png", 100f);
            ...
            __instance.taskTabButton.inactiveSprites.GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("TONE.Resources.Images.DefaultPlate.png", 135f);
            ...
            __instance.rolesTabButton.inactiveSprites.GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("TONE.Resources.Images.DefaultPlate.png", 135f);
            ...
            panelRole.titleText.outlineWidth = LangHasSensitiveOutlineText() ? 0.09f : 0.23f;
            ...
            panelRole.chanceTitle.outlineWidth = LangHasSensitiveOutlineText() ? 0.09f : 0.2f;
            ...
            var chanceTransform = panelRole.transform.FindChild("Chance");
            if (chanceTransform != null)
            {
                chanceTransform.localPosition = new(2.5f, -0.02f, -1f);
            }

            // Max count sprite
            var valueTransform = panelRole.transform.FindChild("Value");
            if (valueTransform != null)
            {
                valueTransform.localPosition = new(0.35f, -0.02f, -1f);
            }
            ...
            categoryHeaderRoleTitle.outlineWidth = LangHasSensitiveOutlineText() ? 0.09f : 0.2f;
            ...
            advancedRolePanelTitle.outlineWidth = LangHasSensitiveOutlineText() ? 0.067f : 0.2f;
            ...
            __instance.taskTabButton.buttonText.text = GetString("TabVanilla.GameSettings");
            ...
            ShowOnlyEnabledRolesButton.buttonText.text = OnlyEnabledRoles
                    ? GetString($"LobbyViewSettings_ShowAlldRolesButtonText")
                    : GetString($"LobbyViewSettings_ShowOnlyEnabledRolesButtonText");
            ...
            rightButtonActiveSprite.sprite = Utils.LoadSprite("TONE.Resources.Images.ActiveNextButton.png", 100f);

            var rightPassiveButton = rightButton.gameObject.GetComponent<PassiveButton>();
            rightPassiveButton.OnClick = new();
            if (GameStates.IsNormalGame) rightPassiveButton.OnClick.AddListener((UnityAction)OnRightPassiveClick);
    ...
    public static bool DrawNormalTab_Prefix(LobbyViewSettingsPane __instance)
    {
        ...
        try
        {
            if (ShowOnlyEnabledRolesButton != null && ShowOnlyEnabledRolesButton.gameObject != null)
                ShowOnlyEnabledRolesButton.gameObject.SetActive(false);
        }
        catch { }
    ...
    private static void HideTab(TabGroup tabName, PassiveButton buttonTab)
    {
        try
        {
            if (buttonTab.gameObject == null) return;
    ...
    public static void SetTabPatch_Postfix(LobbyViewSettingsPane __instance)
    {
        ...
        __instance.gameModeText.text = GetString(LastGameModeSelected.ToString());
    ...
    private static void DrawOptions(LobbyViewSettingsPane viewSettings, TabGroup tabName)
    {
        ...
        if (ShowOnlyEnabledRolesButton?.gameObject != null)
            ShowOnlyEnabledRolesButton.gameObject.SetActive(false);
                    ...
                    switch (data.Type)
                    {
                        case OptionTypes.Checkbox:
                            ...
                            Color32 color = LastGameModeSelected == CustomGameMode.Standard ? tabName switch
                            {
                                ...
                                TabGroup.NeutralRoles => new Color32(127, 140, 141, 255),
                                TabGroup.CovenRoles => new Color32(172, 66, 242, 255),
                                _ => new Color32(255, 129, 166, 255)
                            } : Main.GameModeColors.TryGetValue(LastGameModeSelected, out var c) ? c : new Color32(255, 129, 166, 255);
    ...
    private static void DrawRoles(LobbyViewSettingsPane viewSettings, TabGroup tabName)
    {
        ...
        string htmlcolor = tabName switch
        {
        ...
        categoryHeaderMasked.Title.outlineWidth = LangHasSensitiveOutlineText() ? 0.09f : 0.4f;
        ...
        IEnumerator CoDrawRoleList()
        {
                    ...
                    try
                    {
                        ...
                        if (enabledOrNotCollapsed)
                        {
                            ...
                            if (roleDisabled)
                            {
                                ...
                                {
                                    //viewSettingsInfoPanelRoleVariant.chanceText.text = $"{GetString("RoleOff")}/{chanceAddOnPerGame}";
                                    viewSettingsInfoPanelRoleVariant.chanceText.text = GetString("RoleOff");
                                    viewSettingsInfoPanelRoleVariant.chanceText.outlineWidth = LangHasSensitiveOutlineText() ? 0.09f : 0.26f;
                                }
                            ...
                            else
                            {
                                if (role.IsAdditionRole())
                                {
                                    viewSettingsInfoPanelRoleVariant.chanceText.text = $"{GetString("RoleRate")}/{chanceAddOnPerGame}";
                                    viewSettingsInfoPanelRoleVariant.chanceText.outlineWidth = LangHasSensitiveOutlineText() ? 0.09f : 0.26f;
                                }
            ...
            IEnumerator CoShowRoleSettings()
            {
                ...
                foreach (var role in RoleEnabledList)
                {
                    ...
                    if (optionRole == null || optionRole == default)
                    {
                        continue;
                    }
    ...
    private static float SetUpCustomRoleSettings(this LobbyViewSettingsPane viewSettings, CustomRoles role, OptionItem optionRole, TabGroup tabName, float spacingY, int maskLayer, float xPosRoleHeader, float startY)
    {
        ...
        {
            var tabColor = tabName.GetTabColor();
